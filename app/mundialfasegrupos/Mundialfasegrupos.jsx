                    ...
                    <section className={` block relative w-full pt-12 mb-12 px-4 gx:px-0 text-neutral-700 `}>
                        <div className={` relative flex flex-col gx:flex-row max-w-5xl mx-auto `}>
                            <div className={` gx:w-8/12 `} data-aos-once="true" data-aos="fade-up">
                                <h2 className={` text-center font-BebasNeue text-blue-950 text-5xl mx-8 mb-6 pt-12 `}>Mundial 2026 - fase de grupos<br /></h2>
                                ...
                                <h2 className={` text-center font-BebasNeue text-blue-950 text-5xl mx-8 mb-6 `}>Del sábado 8 al viernes 21 de agosto</h2>
                                <p className={` font-Roboto text-md leading-relaxed mb-4 text-justify hyphens-auto indent-5 `} >
                                    Desde el sábado 8 viernes 21 de agosto de 2026 realizaremos nuestro campus de Hockey con evento. La copa del mundo se juega en Bélgica y Países Bajos, por lo que nuestros deportistas asistirán a las primeras 3 jornadas del mundial alentando a las Leonas.  En este viaje también visitaremos Barcelona, desarrollaremos 10 entrenamientos específicos de tecnificación individual, conviviendo con una Leona Olímpica que acompañará el grupo y convivirá con nuestras deportistas. Deporte, turismo y cultura en un viaje único.
                                </p>
